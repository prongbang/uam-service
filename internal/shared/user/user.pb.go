...
// 	protoc        v4.24.3
// source: internal/shared/uam/uam.proto
...
var file_internal_shared_user_user_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x22, 0x6a, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0x38,
...
var file_internal_shared_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_shared_user_user_proto_goTypes = []interface{}{
	(*UserRequest)(nil),  // 0: uam.UserRequest
	(*UserResponse)(nil), // 1: uam.UserResponse
}
var file_internal_shared_user_user_proto_depIdxs = []int32{
	0, // 0: uam.User.GetUser:input_type -> uam.UserRequest
	1, // 1: uam.User.GetUser:output_type -> uam.UserResponse
