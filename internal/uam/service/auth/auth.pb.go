...
type AuthEnforceRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AuthEnforceRequest) Reset() {
	*x = AuthEnforceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_uam_service_auth_auth_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AuthEnforceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthEnforceRequest) ProtoMessage() {}

func (x *AuthEnforceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_uam_service_auth_auth_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthEnforceRequest.ProtoReflect.Descriptor instead.
func (*AuthEnforceRequest) Descriptor() ([]byte, []int) {
	return file_internal_uam_service_auth_auth_proto_rawDescGZIP(), []int{5}
}

func (x *AuthEnforceRequest) GetSubject() string {
	if x != nil {
		return x.Subject
	}
	return ""
...
func (x *AuthEnforceRequest) GetObject() string {
	if x != nil {
		return x.Object
	}
	return ""
...
func (x *AuthEnforceRequest) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
type AuthEnforceResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AuthEnforceResponse) Reset() {
	*x = AuthEnforceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_uam_service_auth_auth_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AuthEnforceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthEnforceResponse) ProtoMessage() {}

func (x *AuthEnforceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_uam_service_auth_auth_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthEnforceResponse.ProtoReflect.Descriptor instead.
func (*AuthEnforceResponse) Descriptor() ([]byte, []int) {
	return file_internal_uam_service_auth_auth_proto_rawDescGZIP(), []int{6}
}

func (x *AuthEnforceResponse) GetAllowed() bool {
	if x != nil {
		return x.Allowed
	}
	return false
...
var file_internal_uam_service_auth_auth_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x5e,
	0x0a, 0x12, 0x41, 0x75, 0x74, 0x68, 0x45, 0x6e, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x52, 0x65, 0x71,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2f,
	0x0a, 0x13, 0x41, 0x75, 0x74, 0x68, 0x45, 0x6e, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73,
	...
	0x8a, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x2e, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69,
	...
	0x66, 0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x41,
	...
	,
...
var file_internal_uam_service_auth_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_internal_uam_service_auth_auth_proto_goTypes = []interface{}{
	...
	(*AuthEnforceRequest)(nil),      // 5: auth.AuthEnforceRequest
	(*AuthEnforceResponse)(nil),     // 6: auth.AuthEnforceResponse
}
var file_internal_uam_service_auth_auth_proto_depIdxs = []int32{
	...
	5, // 3: auth.Auth.RestEnforce:input_type -> auth.AuthEnforceRequest
	5, // 4: auth.Auth.RbacEnforce:input_type -> auth.AuthEnforceRequest
	2, // 5: auth.Auth.Login:output_type -> auth.AuthResponse
	4, // 6: auth.Auth.VerifyToken:output_type -> auth.AuthVerifyTokenResponse
	6, // 7: auth.Auth.RestEnforce:output_type -> auth.AuthEnforceResponse
	6, // 8: auth.Auth.RbacEnforce:output_type -> auth.AuthEnforceResponse
...
func file_internal_uam_service_auth_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_uam_service_auth_auth_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthEnforceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internal_uam_service_auth_auth_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthEnforceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
